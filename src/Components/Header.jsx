...
export default function Header() {
    return (
        ...
        <header className="lg:sticky lg:top-0 lg:flex w-full lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-20">
            <div >
                ...
                <p className="mt-4 max-w-xs leading-normal">I'm a learner and developer for ReactJS. Every
                    day, I'm getting better.</p>
